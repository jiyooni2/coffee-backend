...
-- CreateIndex
CREATE UNIQUE INDEX "CoffeeShop_id_key" ON "CoffeeShop"("id");

-- CreateIndex
CREATE UNIQUE INDEX "CoffeeShop_latitude_longitude_key" ON "CoffeeShop"("latitude", "longitude");

-- CreateIndex
CREATE UNIQUE INDEX "Category_id_key" ON "Category"("id");

-- CreateIndex
CREATE UNIQUE INDEX "CoffeeShopPhoto_id_key" ON "CoffeeShopPhoto"("id");
